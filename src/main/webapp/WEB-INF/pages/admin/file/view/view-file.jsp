	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table class="table table-striped table-bordered table-list">
				...
				<tbody>
					<tr ng-repeat="ft in fileType">
						<td>{{$index+1}}</td>
						<td>{{ft.FILE_NAME}}</td>
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateFileType(this)" data-toggle="modal"
							data-target="#addFileType"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removeFileType(ft.FILE_ID)"><em
