...
<body class="hold-transition skin-blue sidebar-mini"
	ng-controller="expertController" ng-init="getDataOfPosition()">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table class="table table-striped table-bordered table-list">
				...
				<tbody>
					<tr ng-repeat="pos in positionObject">
						<td>{{$index+1}}</td>
						<td>{{pos.POSITION_NAME}}</td>
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdatePostion(this)" data-toggle="modal"
							data-target="#addPosition"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removePosition(pos.POSITION_ID)"><em
								class="fa fa-trash"></em></a></td>
					</tr>
				</tbody>
			</table>
			<div id="POSITION_PAGIN"></div>
		</div>
		<!-- /.content-wrapper -->
