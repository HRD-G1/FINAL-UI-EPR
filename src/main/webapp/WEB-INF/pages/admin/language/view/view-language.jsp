				...
				<tbody>
					<tr ng-repeat="lan in languageObject">
						...
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateLanguage(this)" data-toggle="modal"
							data-target="#addLanguage"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removeLanguage(lan.LANGUAGE_ID)"><em
