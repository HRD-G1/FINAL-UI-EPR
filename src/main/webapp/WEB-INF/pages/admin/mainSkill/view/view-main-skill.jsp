				...
				<tbody>
					<tr ng-repeat="mks in mainSkillSet">
						...
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateMainSkill(this)" data-toggle="modal"
							data-target="#addMainSkill"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger"
							ng-click="removeMainSkill(mks.SUBJECT_CATEOGRY_ID)"><em
