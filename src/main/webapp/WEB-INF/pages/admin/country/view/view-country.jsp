	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table class="table table-striped table-bordered table-list">
				...
				<tbody>
					<tr ng-repeat="cou in countryObject">
						<td>{{$index+1}}</td>
						<td>{{cou.COUNTRY_NAME}}</td>
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateCountry(this)" data-toggle="modal"
							data-target="#addCountry"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removeCountry(cou.COUNTRY_ID)"><em
