...
<body class="hold-transition skin-blue sidebar-mini"
	ng-controller="expertController">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table class="table table-striped table-bordered table-list">
				...
				<tbody>
					<tr ng-repeat="dis in districtObject">
						<td>{{$index+1}}</td>
						<td>{{dis.DISTRICT_NAME}}</td>
						<td>{{dis.CITY_OR_PROVINCE_NAME}}</td>
						<td>{{dis.COUNTRY_NAME}}</td>
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateDitrict(this)" data-toggle="modal"
							data-target="#addDistrict"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removeDistrict(dis.DISTRICT_ID)"><em
								class="fa fa-trash"></em></a></td>
					</tr>
				</tbody>
			</table>
			<div id="DISTRICT_PAGIN"></div>
		</div>
		<!-- /.content-wrapper -->
