	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table class="table table-striped table-bordered table-list">
				...
				<tbody>
					<tr ng-repeat="pro in provinceOrCity">
						<td>{{$index+1}}</td>
						<td>{{pro.CITY_OR_PROVINCE_NAME}}</td>
						<td>{{pro.COUNTRY_NAME}}</td>
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateCityOrProvince(this)" data-toggle="modal"
							data-target="#addProvince"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger"
							ng-click="removeCityOrProvince(pro.CITY_OR_PROVINCE_ID)"><em
								class="fa fa-trash"></em></a></td>
					</tr>
				</tbody>
			</table>
			<div id="PROVINCE_PAGIN"></div>
		</div>
		<!-- /.content-wrapper -->
