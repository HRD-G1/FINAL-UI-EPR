				...
				<tbody>
					<tr ng-repeat="com in communeObject">
						...
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateCommune(this)" data-toggle="modal"
							data-target="#addCommune"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removeCommune(com.COMMUNE_ID)"><em
								class="fa fa-trash"></em></a></td>
					</tr>
				</tbody>
			</table>
			<div id="COMMUNE_PAGIN"></div>
		</div>
		<!-- /.content-wrapper -->
		<!-- Control Sidebar -->
