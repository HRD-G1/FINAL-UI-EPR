				...
				<tbody>
					<tr ng-repeat="maj in majorObject">
						...
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateMajor(this)" data-toggle="modal"
							data-target="#addMajor"><em class="fa fa-pencil"></em></a> <a
							class="btn btn-danger" ng-click="removeMajor(maj.MAJOR_ID)"><em
