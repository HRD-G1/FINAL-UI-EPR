...
<body class="hold-transition skin-blue sidebar-mini"
	ng-controller="expertController" ng-init="getDataOfInstitution()">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table class="table table-striped table-bordered table-list">
				...
				<tbody>
					<tr ng-repeat="ints in institutionObject">
						<td>{{$index+1}}</td>
						<td>{{ints.INSTITUTION_NAME}}</td>
						<td>{{ints.INSTITUTION_ADDRESS}}</td>
						<td align="center"><a class="btn btn-default"
							ng-click="getUpdateInstitution(this)" data-toggle="modal"
							data-target="#addInstitution"><em class="fa fa-pencil"></em></a>
							<a class="btn btn-danger"
							ng-click="remvoeInstitution(ints.INSTITUTION_ID)"><em
								class="fa fa-trash"></em></a></td>
					</tr>
				</tbody>
			</table>
			<div id="INSTITUTION_PAGIN"></div>
		</div>
		<!-- /.content-wrapper -->
